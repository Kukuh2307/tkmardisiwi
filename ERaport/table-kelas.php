                ...
                <div class="card-body">
                    <table class="table table-hover" id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $querySiswa = mysqli_query($koneksi, "SELECT * FROM siswa WHERE kelas='$kelas'");
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="add-ERaport.php?nis=<?=$data['nis']?>&kelas=<?=$data['kelas']?>" class="btn btn-sm btn-warning" title="Edit"><i class="fa-solid fa-pen"></i></a>
                                    <a href="table-ERaport.php?nis=<?=$data['nis']?>" class="btn btn-sm btn-primary"><i class="fa-solid fa-list"></i></a>
                                </td>
                            </tr>
                            <?php
                            }
