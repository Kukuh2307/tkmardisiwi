<body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?=$main_url?>index.php">TK MARDISIWI</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end text-black" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="<?=$main_url?>/otherElement/profile-sekolah.php">Profile Sekolah</a></li>
